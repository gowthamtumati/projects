...
public class ConvertToBigJSON {
	...
	public static void main(String[] args) {
		...
		try {
			...
			reader = new BufferedReader(new FileReader("/home/abc/IR/Project/OutputFiles/part-r-000002"));
			...
			BufferedWriter writer = new BufferedWriter(new FileWriter("/home/abc/IR/Project/OutputFiles/bigJSON.txt"));
